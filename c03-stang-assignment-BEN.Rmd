...
The graph contradicts the claim.  Larger thicknesses appear to behave differently than thinner thicknesses.  

Both could be true, given that there may be edge effects and confounding factors working with very thin samples. 
