...
Larger carat tends to correspond to larger price. 
Smaller carat has a smaller variability in price than larger carat. 
Carat appears to be somewhat noncontinuous, with certain buckets that have much higher counts. 
...
At a given size, the ideal tend to have a highest price and fair tends to have lowest price. 
However at a given size there is price variation that cannot be fully explained by cut. 
