...
``` r
df_stang_long %>% group_by(alloy) %>% summarize()
```
...
**Observations**:
  ...
  - What angles were tested? 0, 45, 90

  - What thicknesses were tested? 0.022  
    0.032  
    0.064  
    0.081  
...
How does E or Mu vary with Angle?
...
![](c03-stang-assignment-BEN_files/figure-gfm/q3-task-1.png)<!-- -->
...
![](c03-stang-assignment-BEN_files/figure-gfm/q3-task-2.png)<!-- -->

``` r
df_stang_long %>%
 ggplot()+
geom_abline(mapping = aes(intercept = .315, slope = 0.000001))+
  geom_point(mapping = aes( x = E, y = mu, color = factor(thick)))
```

![](c03-stang-assignment-BEN_files/figure-gfm/q3-task-3.png)<!-- -->
...
![](c03-stang-assignment-BEN_files/figure-gfm/q4-vis-1.png)<!-- -->

**Observations**:

  - Does this graph support or contradict the claim above?

The graph contradicts the claim. Larger thicknesses appear to behave
differently than thinner thicknesses.

Both could be true, given that there may be edge effects and confounding
factors working with very thin samples.
